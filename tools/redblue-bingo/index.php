...
<head>
	<!-- Title -->
	<title>Pok&eacute;mon Red/Blue Bingo - SpeedRunsLive</title>
	
	<!-- Meta -->
	<meta name="description" content="Generates 'Bingo' boards for Pok&eacute;mon Red/Blue" />
	<meta name="keywords" content="pokemon, bingo" />
	...
	<script src="/scripts/bingo/redblue-bingo.js?<?php echo time(); ?>" type="text/javascript"></script>

	<div id="bingoPage">
		<div id="about_bingo">
			<h1>Pok&eacute;mon Red/Blue Bingo</h1>
			...
			<p>This is a "Bingo" board for Pok&eacute;mon Red/Blue races.</p>
			...
			<p><span class="note">Pok&eacute;mon Red/Blue itemlist by werster. SRL Bingo v5 by Cosmo.</span></p>
