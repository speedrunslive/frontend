...
<head>
	<!-- Title -->
	<title>Pok&eacute;mon Crystal Bingo - SpeedRunsLive</title>
	
	<!-- Meta -->
	<meta name="description" content="Generates 'Bingo' boards for Pok&eacute;mon Crystal" />
	...
	<script src="/scripts/bingo/crystal-bingo.js?<?php echo time(); ?>" type="text/javascript"></script>

	<div id="bingoPage">
		<div id="about_bingo">
			<h1>Pok&eacute;mon Crystal Bingo</h1>
			...
			<p>This is a "Bingo" board for Pok&eacute;mon Crystal races.</p>
			...
			<p><span class="note">Pok&eacute;mon Crystal itemlist by werster. SRL Bingo v5 by Cosmo.</span></p>
