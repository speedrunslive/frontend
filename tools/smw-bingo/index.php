...
<head>
	...
	<script src="/scripts/bingo/smw-bingo.js?<?php echo time(); ?>" type="text/javascript"></script>
	...
	<div id="bingoPage">
		<div id="about_bingo">
			...
			<!--<?php echo ('<a class="newcard" href="smw-bingo-short.php?seed='.mt_rand(0, 999999).'">Short card</a>'); ?>-->
