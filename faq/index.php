...
<head>
	...
	<div id="faq">
<h1>Frequently asked questions&ensp;<a href=""><img class="flag" src="http://cdn.speedrunslive.com/images/flags/United_States_of_America.png" alt="En"/></a><a href="./sp/"><img src="http://cdn.speedrunslive.com/images/flags/Spain.png" class="flag" alt="Sp"/></a></h1>	
<br>
<h1 id="intro">Introduction to speedrunning and SpeedRunsLive</h1>
<h2 id="what">What is speedrunning?</h1>
...
<br>
<h2 id="whatsrl">What is SpeedRunsLive?</h1>
...
<h2 id="whatsrlraces">What are SRL Races?</h1>
...
<h2 id="join">How do I participate in SRL races?</h1>
...
<li>SRL is fully supported by donations. You could always help by donating <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=SQ2NXSJRUVWLW">here</a>! 100% of donations go towards the various costs associated with keeping the SRL site and IRC running.
</ul>
<br>
...
<p>Also, if you're still feeling unsure of how everything works here, feel free to lurk in <strong>#speedrunslive</strong>, check out a few races, linger in race channels, and ask questions (even if the people tell you to look at the FAQ again, which isn't a bad idea either).</p>
	...
	<h1 id="whatsrl">What is SpeedRunsLive?</h1>
		...
		Races are livestreamed so others can watch the action.</p>
	...
	<h1 id="regnick">How do I register my IRC nickname?</h1>
		...
		<p><code>/nickserv register password e-mail</code></p>

		<p>where <em>password</em> should be replaced by your password, and <em>e-mail</em> should be replaced by your e-mail address.  
