...
Behavior.setup = function () {
  ...
  for (var i=1;i<=25;i++) {
    ...
    comboBreaker = 0;
    $('#slot'+i).append('<p>' + thisName + '</p>'); // add the name to the square
  ...
  function populateList() {
    ...
    bingoList[d].push({ name: "20 Deku Sticks", type: "deku" });
    ...
    bingoList[d].push({ name: "Bottled Poe", type: "bottle" });
    ...
    bingoList[d].push({ name: "All Kokiri Forest area Skulltulas", type: "skulltula" });
    ...
    d++;
    bingoList[d].push({ name: "At least 3 songs", type: "songs" });
    ...
    d++;
    bingoList[d].push({ name: "Sun's Song", type: "songs" });
    bingoList[d].push({ name: "Forest Medallion", type: "forest" });
    bingoList[d].push({ name: "All Lost Woods area Skulltulas", type: "skulltula" });
    ...
    bingoList[d].push({ name: "All Skulltulas in Jabu-Jabu", type: "jabu" });
    bingoList[d].push({ name: "All Skulltulas in Ice Cavern", type: "ice" });
    ...
    d++;
    bingoList[d].push({ name: "All Skulltulas in Dodongo's Cavern", type: "dc" });
    bingoList[d].push({ name: "Odd Potion", type: "atrade" });
    bingoList[d].push({ name: "At least 4 songs", type: "songs" });
    ...
    bingoList[d].push({ name: "Keaton Mask", type: "mask" });
    ...
    bingoList[d].push({ name: "At least 5 songs", type: "songs" });
    d++;
    ...
    bingoList[d].push({ name: "All Skulltulas in Deku Tree", type: "deku" });
    bingoList[d].push({ name: "Mirror Shield", type: "ice" });
    bingoList[d].push({ name: "3 Shields", type: "ice" });
    bingoList[d].push({ name: "At least 6 songs", type: "songs" });
    ...
    bingoList[d].push({ name: "All Kakariko area Skulltulas", type: "skulltula" });
    d++;
    bingoList[d].push({ name: "All Gerudo Valley area Skulltulas", type: "skulltula" });
    bingoList[d].push({ name: "Bottled Big Poe", type: "bigpoe" });
    bingoList[d].push({ name: "All Skulltulas in Forest Temple", type: "forest" });
    bingoList[d].push({ name: "Farore's Wind", type: "fw" });
    bingoList[d].push({ name: "All Lon-Lon Ranch area Skulltulas", type: "jabu" });
    bingoList[d].push({ name: "All Skulltulas in Bottom of the Well", type: "botw" });
    ...
    bingoList[d].push({ name: "All Skulltulas in Fire Temple", type: "fire" });
    bingoList[d].push({ name: "Spirit Medallion", type: "spirit" });
    ...
    bingoList[d].push({ name: "At least 7 songs", type: "songs" });
    d++;
    ...
    bingoList[d].push({ name: "Skull Mask", type: "mask" });
    bingoList[d].push({ name: "Stone of Agony", type: "agony" });
    bingoList[d].push({ name: "Spooky Mask", type: "mask" });
    d++;    
    ...
    bingoList[d].push({ name: "All Skulltulas in Shadow Temple", type: "shadow" });
    bingoList[d].push({ name: "All Hyrule Field area Skulltulas", type: "skulltula" });
    bingoList[d].push({ name: "At least 8 songs", type: "songs" });
    d++;
    bingoList[d].push({ name: "Map & Compass in Spirit Temple", type: "spirit" });
    bingoList[d].push({ name: "7 Hearts", type: "hearts" });
    bingoList[d].push({ name: "All Death Mountain area Skulltulas", type: "skulltula" });
    ...
    bingoList[d].push({ name: "All Zora's Domain area Skulltulas", type: "jabu" });
    ...
    bingoList[d].push({ name: "Bunny Hood", type: "mask" });
    d++;
    ...
    bingoList[d].push({ name: "All Skulltulas in Spirit Temple", type: "spirit" });
    bingoList[d].push({ name: "At least 9 songs", type: "songs" });
    d++;
    ...
    bingoList[d].push({ name: "All Market area Skulltulas", type: "skulltula" });
    bingoList[d].push({ name: "8 Hearts", type: "hearts" });
    bingoList[d].push({ name: "All Skulltulas in Water Temple", type: "water" });
    bingoList[d].push({ name: "All Lake Hylia Skulltulas", type: "skulltula" });
    bingoList[d].push({ name: "Claim Check", type: "atrade" });
    bingoList[d].push({ name: "Quiver (50)", type: "forest" });
    bingoList[d].push({ name: "At least 10 songs", type: "songs" });
  }
